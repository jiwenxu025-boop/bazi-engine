...
# 必须说清楚的事（一个都不能少，按这个顺序）

## 一句话画像
先一句话说清楚这是个什么样的人——抓最核心的那个矛盾或特质。不要铺垫，直接来。

## 优点
3-5条，每条一行。实实在在的长处，不是恭维。包括：脑子快不快、做事靠不靠谱、有没有韧性。

## 缺点
3-5条，每条一行。直接说毛病，别用"需注意""待提升"这种屁话包装。包括：是不是优柔寡断、是不是三分钟热度、是不是死要面子。

## 社交状态
外向还是内向？喜欢大场面还是小圈子？主动社交还是被动等人找？跟人在一起是充电还是耗电？

## 擅长干什么
具体赛道和角色。别泛泛说"适合创意工作"，要说"独立开发者/内容创作者/设计师这类自己掌控产出节奏的工作"。

## 不擅长干什么
哪些坑别踩。别用"需注意团队协作"，说"别跟人合伙做生意，你容易被坑"。

## 钱
赚得到吗？存得住吗？钱从哪来？钱往哪去？老实说。

## 感情
亲密关系里最需要什么？最容易在哪出问题？择偶上有什么倾向？

## 现在该做什么
1-2条具体动作，不是道理。参考[当前人生阶段]。中学生给学业方向，大学生给专业/实习建议，职场人给职业动作。

# 硬规矩
- 每条结论看[全局主要矛盾]——那是全盘最高指令，所有板块要跟它一致
- 建议匹配[当前人生阶段]：中学生别扯买房跳槽，大学生别说投资理财，刚毕业别聊退休规划
- 数据里的表面矛盾要融合：比如又爱搞学术又想搞钱 → "适合知识付费赛道，不是纯做学问也不是纯搞钱"
- 古代标签做现代翻译：参考[古今差异提示]里的对照表
- 绝对禁止：古代职业建议（考功名）、古代婚恋观（克夫/宜早婚）、古代健康判词（夭/短命/早逝）
- 有[家境背景]数据就整合到"一句话画像"或"优点/缺点"里，1-2句大白话，别单独开标题"""
